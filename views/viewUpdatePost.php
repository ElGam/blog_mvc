    ...
    <h6>Modifié le <?=$post->date()?></h4><br>
                   ...
                   <div class="form-group">
                       <form method="post" action="Post&update=1&id=<?= $_GET['id']?>">
                           ...
                           <textarea name="chapo" class="form-control" style="width:65%" rows="15"><?= $post->chapo(); ?></textarea><br>
                           
                           <label for="content">Contenu:</label>
                           <textarea name="content" class="form-control" style="width:75%" rows="25"><?= $post->content(); ?></textarea><br>
